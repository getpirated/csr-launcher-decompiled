...
contextBridge.exposeInMainWorld("api", {
  ...
  game: {
    ...
    checkBeforeLaunch: () =>
      ipcRenderer.invoke("check-and-update-before-launch"),
    downloadWithProgress: (gameDir) =>
      ipcRenderer.invoke("download-updates-with-progress", gameDir)
  },
  settings: {
  ...
  csr: {
    ...
    downloadFiles: (gameDir) =>
      ipcRenderer.invoke("download-csr-files", gameDir),
