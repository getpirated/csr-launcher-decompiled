...
> [!NOTE]
> Tl;dr - The launcher doesn't have anything RAT/malware related. If someone actually bricked their PC or got RATed by CS:R, then it's probably because of game files which are downloaded from https://download.csrestored.fun/. Good luck with scanning, decompiling or reverse engineering each file though...
